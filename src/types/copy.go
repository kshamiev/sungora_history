...
// CopyTyp Копирование объектов. Копируются данные свойств оригинальные имена которых совпадают в исходном и целевых объектах
...
// CopyTypFilter Копирование объектов. Копируются данные свойств оригинальные имена которых совпадают в исходном и целевых объектах
// Копирвоание срезов, хешей, единичных объектов (!по указателям!)
...
// copyStructure Непосредственное копирование данных свойств исходного объекта в целевой
