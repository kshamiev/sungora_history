// Бибилотека: Загрузка бинарных данных на сервер.
package uploader
...
// Загружает файл во временное хранилище и возвращает уникальный идентификатор файла.
// По истечении времени жизни, если файл не будет востребован, он удаляется из временного хранилища автоматически.
//	+ req *http.Request объект запроса
//	+ field string имя поля формы файла
...
// Получение ранее загруженного файла по ключу
//	+ key string уникальный идентификатор файла
//	- *Response данные загруженные на сервер
//	- error ошибка операции
...
//	+ folder string абсолютный путь к временной папке с файлами
//	+ minute int время жизни загруженых файлов в минутах
...
// Получение формы с файлами, enctype="multipart/form-data"
